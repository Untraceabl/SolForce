...
async function main(){
    ...
    const myKeypair = loadWalletKey("D9KAcwiNvSeoSTZqyA1DvgzNoVtXG5F7oojUuJ1s5Hdq.json");
    const mint = new web3.PublicKey("26GzxRp7YuTh8kmSWgySQG4eyxfbec9TA2JiYfYgVbpQ");
    ...
    const ourMetadata = { // TODO change those values!
        name: "SolForce", 
        symbol: "SFR",
        uri: "https://raw.githubusercontent.com/Untraceabl/SolForce/main/MetadataUpdate/metadata.json",
    }
    const onChainData = {
        ...ourMetadata,
        // we don't need that
